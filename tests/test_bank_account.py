...
class BankAccountTests(unittest.TestCase):
    ...
    def test_withdraw_decreases_balance_by_withdraw_amount(self, mock_datetime):
        mock_today = mock_datetime.date.today.return_value
    ...
    @patch("src.bank_account.datetime")
    def test_withdraw_during_bussines_days_Monday(self, mock_datetime):
        mock_today = mock_datetime.date.today.return_value
        mock_today.weekday.return_value = 0
        mock_datetime.now.return_value.hour = 8
        new_balance = self.account.withdraw(100)
    ...
    @patch("src.bank_account.datetime")
    def test_withdraw_during_bussines_days_Sunday(self, mock_datetime):
        mock_today = mock_datetime.date.today.return_value
        mock_today.weekday.return_value = 6
        mock_datetime.now.return_value.hour = 8
